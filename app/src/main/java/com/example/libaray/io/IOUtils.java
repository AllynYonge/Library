 ...
 */
package com.example.libaray.io;

import android.os.Build;

import com.example.libaray.io.stream.ByteArrayOutputStream;
import com.example.libaray.io.stream.StringBuilderWriter;
...
public class IOUtils {
     ...
     * before using {@link com.example.libaray.io.IOUtils#toByteArray(InputStream, int)} to read into the byte array.
     ...
     * @see com.example.libaray.io.IOUtils#toByteArray(InputStream, int)
     * @since 2.1
     */
