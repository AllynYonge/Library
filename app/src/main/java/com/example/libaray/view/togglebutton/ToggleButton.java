package com.example.libaray.view.togglebutton;
...
import com.example.libaray.view.togglebutton.facebook.rebound.SimpleSpringListener;
import com.example.libaray.view.togglebutton.facebook.rebound.Spring;
import com.example.libaray.view.togglebutton.facebook.rebound.SpringConfig;
import com.example.libaray.view.togglebutton.facebook.rebound.SpringSystem;
import com.example.libaray.view.togglebutton.facebook.rebound.SpringUtil;
...
public class ToggleButton extends View{
    ...
    /** 开启颜色*/
    private int onColor = Color.parseColor("#4bed90");
    /** 关闭颜色*/
    ...
    public void setup(AttributeSet attrs) {
        ...
        offBorderColor = typedArray.getColor(R.styleable.IOSToggleButton_offBorderColor, offBorderColor);
        onColor = typedArray.getColor(R.styleable.IOSToggleButton_onColor, onColor);
        spotColor = typedArray.getColor(R.styleable.IOSToggleButton_spotColor, spotColor);
        offColor = typedArray.getColor(R.styleable.IOSToggleButton_offColor, offColor);
        borderWidth = typedArray.getDimensionPixelSize(R.styleable.IOSToggleButton_borderSize, borderWidth);
        defaultAnimate = typedArray.getBoolean(R.styleable.IOSToggleButton_animate, defaultAnimate);
        isDefaultOn = typedArray.getBoolean(R.styleable.IOSToggleButton_isDefaultOn, isDefaultOn);
        typedArray.recycle();
